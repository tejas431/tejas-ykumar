...
NODE multiply(NODE poly1,NODE poly2)
{
    ...
    int main()
    {
      ...
      int n, i,co,po;
      printf("\n read the no. of terms of first polynomial: ");
      scanf("%d",&n);
      for(i=1;i<=n;i++)
      {
      ...
      printf("|n first polynomial is \n");
      display(poly1);
      printf("\n read the no .of terms of second polynomial :");
      scanf("%d",&n);
      for(i=1;i<=n;i++)
      {
          printf("\n read co & po of %d term: ",i);
       ...
       printf("|n second polynomial is \n");
      display(poly2);
      poly = multiply(poly1 ,poly2 );
      printf("\n resulted polynomials is  \n");
      display(poly);
      return 0;
    }
